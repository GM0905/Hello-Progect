...
<head>
<meta charset="utf-8">
<title>写文章 - 博客管理后台</title>
    <link rel="stylesheet" href="/WGBlog/bootstrap-3.3.7-dist/css/bootstrap.css">
            ...
            <div class="form-group">
              ...
              <div class="add-article-box">
                  ...
                  <div class="add-article-box-content">
                      ...
                      <p><label>发布时间：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="time" id="punishTime" /></span></p>
                  </div>
...
<script src="/WGBlog/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script>

<%--Editormd--%>
<link rel="stylesheet" href="/WGBlog/editormd/css/editormd.css" />
<script src="/WGBlog/js/jquery/jquery-2.1.1.min.js"></script>
<script src="/WGBlog/editormd/editormd.js"></script>
...
<%--异步上传文件js--%>
<script src="/WGBlog/js/ajaxfileupload.js"></script>
<script>
    var editor;
    $(function() {
        editor = editormd("test-editor", {
            width  : "100%",
            height : "500px",
            path   : "/WGBlog/editormd/lib/",//第三方依赖库
            ...
            imageUploadURL : "/WGBlog/editorUpload",//后端上传图片服务地址
        });
    });
    ...
    $('#category').change(function () {
        //获取选中的栏目，把主键发送到后台查询
        $.get("/WGBlog/Article/queryByCategory",
    ...
    $('#img').change(function () {
        $.ajaxFileUpload({
                url: '/WGBlog/fileUpload', //用于文件上传的服务器端请求地址
    ...
    //发送异步请求，查询当前文章信息
    $.get('/WGBlog/Article/queryById',{'id':'${id}'},function (data) {
      //让栏目选中当前文章对应的栏目
    ...
    $.get("/WGBlog/Article/queryCategory",function (data) {
        //List<Category>
        for(var i = 0; i < data.length; i++){
...
$('#categories').change(function () {
  $('#tags').html("");
$.get("/WGBlog/Article/queryTags",{'cid':$(this).val()},function (data) {
for(var i=0;i<data.length;i++){
  $('#tags').append("<input type='checkbox'value="+data[i].tname+"/>"+data[i].tname+"&nbsp;&nbsp;&nbsp;");
    ...
    function punish() {
      ...
      $.post("/WGBlog/Article/saveOrUpdate",{
        'cid' : $('#categories').val(),
        'tagNames' : tagNames,
        'title' : $('#title').val(),
        'digest' : $('#digest').val(),
        ...
        if(data.ok){
          ...
          //跳转到文章列表页面
          location.href="/WGBlog/toView/view/Article/index";
        }
      },'json');
    }
</script>
