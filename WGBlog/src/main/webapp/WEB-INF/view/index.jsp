...
<section class="container-fluid">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">${sessionScope.user.nickname} <span class="caret"></span></a>
              <ul class="dropdown-menu dropdown-menu-left">
                <li><a title="查看或修改个人信息" data-toggle="modal" data-target="#seeUserInfo">修改密码</a></li>
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li><a href="/WGBlog/toView/view/Article/index">文章</a></li>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-hover">
          <tbody>
            ...
            <tr>
              <td>上次登录时间: ${sessionScope.user.nickname} , 上次登录IP: ${sessionScope.user.loginIp}</td>
            </tr>
          </tbody>
        </table>
      </div>--%>
...
<script src="/WGBlog/js/layer-3.5.1/layer.js" type="text/javascript"></script>
<script src="/WGBlog/js/myJs/users.js" type="text/javascript"></script>
</body>
</html>
<script>
    //异步校验旧密码输入是否正确
    $('#oldPwd').blur(function () {
        $.post("/WGBlog/user/verifyOldPwd",{'oldPwd':$(this).val()},function (data) {
            if(!data.ok){
